...
export const Layout: React.FC = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      {/* Sidebar */}
      <style>{`
        .menu-sidebar { background-color: ${coresMenu.fundo} !important; }
        .menu-sidebar a, .menu-sidebar button { color: #D4D1B0 !important; }
        .menu-sidebar .menu-item { color: #D4D1B0 !important; }
        .menu-sidebar .submenu-item { color: #D4D1B0 !important; }
        .menu-sidebar svg { color: #D4D1B0 !important; }
        .menu-sidebar span { color: #D4D1B0 !important; }
        
        /* Hover com cor mais clara */
        .menu-sidebar .menu-item:hover { color: #E8E5C8 !important; }
        .menu-sidebar .menu-item:hover svg { color: #E8E5C8 !important; }
        .menu-sidebar .menu-item:hover span { color: #E8E5C8 !important; }
        .menu-sidebar .submenu-item:hover { color: #E8E5C8 !important; }
        ...
        .menu-sidebar::-webkit-scrollbar-thumb {
          background: rgba(212, 209, 176, 0.3);
          border-radius: 10px;
        }
        .menu-sidebar::-webkit-scrollbar-thumb:hover {
          background: rgba(212, 209, 176, 0.5);
        }
        .menu-sidebar nav::-webkit-scrollbar {
          width: 6px;
        }
        .menu-sidebar nav::-webkit-scrollbar-track {
          background: rgba(0, 0, 0, 0.1);
          border-radius: 10px;
        }
        .menu-sidebar nav::-webkit-scrollbar-thumb {
          background: rgba(212, 209, 176, 0.3);
          border-radius: 10px;
        }
        .menu-sidebar nav::-webkit-scrollbar-thumb:hover {
          background: rgba(212, 209, 176, 0.5);
        }
          ...
          <nav className="flex-1 px-2 py-4 space-y-1 overflow-y-auto">
            ...
            <div>
              ...
              >
                ...
                <svg 
                  className={`w-4 h-4 ml-auto transition-transform ${financeiroOpen ? 'rotate-90' : ''}`}
                  fill="none" 
                  stroke="currentColor" 
                  viewBox="0 0 24 24"
                >
